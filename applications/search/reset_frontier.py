...
from datamodel.search.DrackermJessicmzCaveneg1_datamodel import DrackermJessicmzCaveneg1ProjectionLink
...
@Deleter(DrackermJessicmzCaveneg1ProjectionLink)
@Getter(DrackermJessicmzCaveneg1ProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(DrackermJessicmzCaveneg1ProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(DrackermJessicmzCaveneg1ProjectionLink, l)
